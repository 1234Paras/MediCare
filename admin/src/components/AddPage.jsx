...
const AddPage = () => {
    ...
    //it will show a toast for 3 second
    useEffect(() => {
    ...
    async function handleAdd(e) {
        ...
        try {
            ...
            const API_BASE = "https://medicare-backend-qvrv.onrender.com/api";
        ...
        <div className={s.pageContainer}>
            ...
            <div className={s.maxWidthContainer + " " + s.formContainer}>
                <form onSubmit={handleAdd} className={s.formGrid}>
                    ...
                    <input className={s.inputBase} placeholder="Qualifications"
                    ...
                    <input className={s.inputBase} placeholder="Doctor Email"
                        value={form.email} type="email" onChange={(e) => setForm({ ...form, email: e.target.value })} />
                    ...
                    <div className={s.submitButtonContainer}>
                        <button type="submit" disabled={loading} className={s.submitButton + " " + s.cursorPointer + " " +
