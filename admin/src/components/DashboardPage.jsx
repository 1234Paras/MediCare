...
import { Users, XCircle, UserRoundCheck, CalendarRange, BadgeIndianRupee, CheckCircle, Search } from 'lucide-react';
      ...
      <div className={s.maxWidthContainer}>
        ...
        <div className={s.statsGrid}>
          ...
          <StatCard icon={<UserRoundCheck className="w-6 h-6" />}
            label="Total Registered Users" value={patientCountLoading ? "Loading...." : ( patientCount ?? totals.totalLoginPatients)}/>
