...
// import {Facebook, Twitter, Instagram, Linkedin, Youtube, Stethoscope} from 'lucide-react';
          ...
          <div className={footerStyles.companySection}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 9753468725</span>
              </div>
              ...
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>parasjaincoding@gmail.com</span>
              </div>
              ...
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>Tikamgarh, India</span>
              </div>
            </div>
          </div>
