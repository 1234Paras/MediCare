...
// supporting YYYY-MM-DD
  ...
  //you can get the output as desired that is most recent comes first
  // or the earliest comes first.
}
 ...
 */
//return the number 10 digits only
...
export default function DoctorDetail() {
  ...
  //to make 10 digit max limit for phone number
