...
const DEFAULT_HOST = "https://medicare-backend-qvrv.onrender.com".replace(/\/$/, "");
...
export default function ServiceDetail() {
  ...
  //check is form valid by all fields are filled or not
  ...
  //if there is no service found in the DB
  if (!service) {
    return (
      <div className={serviceDetailStyles.loadingContainer}>
        <div className={serviceDetailStyles.loadingCard}>
